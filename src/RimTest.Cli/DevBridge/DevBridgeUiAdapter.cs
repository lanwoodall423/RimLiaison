...
/// <summary>
/// RimTest-owned routing for the small visual-validation surface. It discovers
        ...
        catch (OperationCanceledException) when (cancellationToken.IsCancellationRequested)
        {
            return new ToolCallResult(
                new DevBridgeUiStatus(
                    ...
                    "RIMTEST_CANCELLED",
                    "The RimTest UI capture request was cancelled.",
                    NextAction: null),
                null);
        }
        catch (Exception)
        {
            return new ToolCallResult(
                new DevBridgeUiStatus(
                    ...
                    "RimTest could not start DevBridge."),
                null);
        }
        ...
        if (process.Cancelled)
        {
            return new ToolCallResult(
                new DevBridgeUiStatus(
                    DevBridgeUiOutcome.Cancelled,
                    "RIMTEST_CANCELLED",
                    "The RimTest UI request was cancelled.",
                    process.ExitCode,
                    NextAction: null),
                null);
        }
        ...
        if (process.StdoutTruncated)
        {
            return new ToolCallResult(
                new DevBridgeUiStatus(
                    ...
                    "DevBridge returned more UI evidence than RimTest can safely inspect.",
                    process.ExitCode),
                null);
        }
