...
internal static class Program
{
    ...
    [
        ...
        ("candidate health is structural only", UnifiedRuntimeOwnershipTests.CandidateHealthReportsStructuralOnly),
        ("candidate health ignores RimWorld executable", UnifiedRuntimeOwnershipTests.CandidateHealthIgnoresRimWorldExecutable),
        ("machine preflight missing root blocks", UnifiedRuntimeOwnershipTests.MachinePreflightMissingRootBlocks),
