...
internal static class Program
{
    ...
    [
        ...
        ("bootstrap quiesces existing runtime", PromotionBootstrapHealthTests.BootstrapQuiescesExistingRuntime),
        ...
        ("foreign coordinator is not stopped", PromotionBootstrapHealthTests.ForeignCoordinatorIsNotStopped),
        ...
        ("candidate contract has no external release workflow", ToolchainCandidateTests.CandidateContractDoesNotExposeExternalReleaseWorkflow),
        ("candidate evidence leaves project unimplicated", ToolchainCandidateTests.CandidateEvidenceMarksProjectUnimplicated),
        ("owned runtime source changes are meaningful", UnifiedRuntimeOwnershipTests.DirtySourcePathsAreMeaningful),
        ("promoted fingerprint includes runtime hashes", UnifiedRuntimeOwnershipTests.PromotedFingerprintIncludesRuntimeHashes),
        ("qualified identity includes runtime hashes", UnifiedRuntimeOwnershipTests.QualifiedIdentityIncludesRuntimeHashes),
        ("owned runtime manifest binds source commit", UnifiedRuntimeOwnershipTests.OwnedRuntimeManifestBindsSourceCommit),
        ("runtime manifest source commit mismatch blocks", UnifiedRuntimeOwnershipTests.RuntimeManifestSourceCommitMismatchBlocks),
        ("runtime manifest missing source commit blocks", UnifiedRuntimeOwnershipTests.RuntimeManifestMissingSourceCommitBlocks),
        ("runtime manifest generation is deterministic", UnifiedRuntimeOwnershipTests.RuntimeManifestGenerationIsDeterministic),
        ("runtime manifest hash mutation blocks", UnifiedRuntimeOwnershipTests.RuntimeManifestHashMutationBlocks),
        ...
        ("candidate health re-verifies CLI closure after self-check", UnifiedRuntimeOwnershipTests.CandidateHealthReverifiesCliClosureAfterSelfCheck),
        ...
        ("machine preflight rejects outside Mods destination", UnifiedRuntimeOwnershipTests.MachinePreflightRejectsOutsideModsDestination),
        ("machine preflight running process blocks", UnifiedRuntimeOwnershipTests.MachinePreflightRunningProcessBlocks),
        ("legacy runtime identity does not satisfy candidate", UnifiedRuntimeOwnershipTests.LegacyRuntimeIdentityDoesNotSatisfyNewCandidate),
